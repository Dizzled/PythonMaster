...
# # Help will print the docstrings
# # help(Song.__init__)
# # print(Song.__doc__)
...
def load_data():
    ...
    with open('albums.txt', 'r') as albums:
        ...
        # After read the last line fo the text file, we will have an artist and album that haven't been stored - process them now
